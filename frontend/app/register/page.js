...
export default function Register() {
  ...
  const register = async () => {
    const res = await fetch("http://18.61.44.172/api/register/", {
      method: "POST",
  ...
  return (
    <>
      <AuthPageShell
        title="Create your reminder account."
        description="Build a routine that feels lighter, clearer, and easier to keep every day."
        badge="Get started"
        formTitle="Create account"
        formDescription="Join with your details or continue with Google."
        footer={
          <>
